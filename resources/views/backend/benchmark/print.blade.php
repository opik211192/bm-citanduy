    ...
    <table class="header-table">
        <tr>
            <td colspan="4" style="text-align: center; vertical-align: middle">
                <img src="{{ public_path('img/citanduy2.jpg') }}" alt="Logo PUPR">
            </td>
    ...
    <table style="margin-top: 30px">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td colspan="5">{{ $benchmark->province->name }}</td>
            </tr>
            <tr>
                <td colspan="4"><b>Latitude</b></td>
                <td colspan="5">{{ $benchmark->lat }}</td>
                <td colspan="4"><b>Longitude</b></td>
                <td colspan="5">{{ $benchmark->long }}</td>
            </tr>
            <tr>
        ...
        <tbody>
            ...
            <tr>
                <td colspan="9" style="text-align:center">
                    ...
                    <img src="{{ public_path('storage/img/foto/' . $benchmark->uploads->foto) }}" alt="Foto"
                        style="max-width: 200px; max-height: 200px;">
                    @endif
                </td>
                <td colspan="9" style="text-align:center">
                    @if ($benchmark->uploads->sketsa)
                    <img src="{{ public_path('storage/img/sketsa/' . $benchmark->uploads->sketsa) }}" alt="Sketsa"
                        style="max-width: 200px; max-height: 200px;">
                    @endif
                </td>
            </tr>
