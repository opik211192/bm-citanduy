...
<div class="col-md-10">
    <div class="card">
        <div class="card-header bg-dark">
            <h4 class="font-weight-bold">Edit Data Benchmark</h4>
        </div>
        <div class="card-body">
            {{-- @if ($errors->any())
            ...
            @endif --}}
            <form method="POST" action="{{ route('benchmark.edit', $benchmark) }}" class="row g-3"
                ...
                <div class="col-md-6 mb-2">
                    ...
                    <input type="text" class="form-control @error('kode_bm') is-invalid @enderror" id=" kode_bm"
                        name="kode_bm" value="{{ old('kode_bm') ?? $benchmark->kode_bm }}" placeholder="Kode BM">
                    @error('kode_bm')
                ...
                <div class="col-md-6 mb-2">
                    ...
                    <input type="text" class="form-control @error('no_registrasi') is-invalid @enderror"
                        ...
                        value="{{ old('no_registrasi') ?? $benchmark->no_registrasi }}" placeholder="No. Registrasi">
                    @error('no_registrasi')
                    <span class="invalid-feedback"><strong>{{ $message }}</strong></span>
                    @enderror
                </div>
                <div class="col-md-6 mb-2">
                    ...
                    <input type="text" class="form-control @error('nama_pekerjaan') is-invalid @enderror"
                        ...
                        value="{{ old('nama_pekerjaan') ?? $benchmark->nama_pekerjaan }}" placeholder="Nama Pekerjaan">
                ...
                <div class="col-md-6 mb-2">
                    ...
                    <select id="jenis_pekerjaan" name="jenis_pekerjaan"
                        ...
                        <option value="embung" {{ $benchmark->jenis_pekerjaan == 'embung' ? 'selected' : '' }}>Embung
                        </option>
                        <option value="bendungan" {{ $benchmark->jenis_pekerjaan == 'bendungan' ? 'selected' : '' }}>
                            Bendungan</option>
                        <option value="bendung" {{ $benchmark->jenis_pekerjaan == 'bendung' ? 'selected' : '' }}>
                            Bendung</option>
                    </select>
                ...
                <div class="col-md-3 mb-2">
                    ...
                    <select id="province_id" name="province_id"
                        ...
                        <option {{ $benchmark->province_id == $item->id ? 'selected' : '' }} value="{{ $item->id ?? ''
                            }}">{{ $item->name ?? '' }}</option>
                        @endforeach
                    </select>
                    @error('province_id')
                ...
                <div class="col-md-3 mb-2">
                    ...
                    <select id="city_id" name="city_id" class="form-control @error('city_id') is-invalid @enderror">
                        ...
                        <option value="{{ $item->id }}" {{ $benchmark->city_id == $item->id ? 'selected' : '' }}>
                            {{ $item->name }}
                        </option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-3 mb-2">
                    ...
                    <select id="district_id" name="district_id"
                        ...
                        <option value="{{ $item->id }}" {{ $benchmark->district_id == $item->id ? 'selected' : '' }}>
                            {{ $item->name }}
                        </option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-3 mb-2">
                    ...
                    <select id="village_id" name="village_id"
                        ...
                        <option value="{{ $item->id }}" {{ $benchmark->village_id == $item->id ? 'selected' : '' }}>
                            {{ $item->name }}
                        </option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-4 mb-2">
                    ...
                    <input type="text" class="form-control @error('utm_x') is-invalid @enderror" id="utm_x" name="utm_x"
                        placeholder="UTM X" value="{{ old('utm_x') ?? $benchmark->utm_x }}" pattern="[0-9.,]*">
                    @error('utm_x')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                ...
                <div class="col-md-4 mb-2">
                    ...
                    <input type="text" class="form-control @error('utm_y') is-invalid @enderror" id="utm_y" name="utm_y"
                        placeholder="UTM Y" value="{{ old('utm_y') ?? $benchmark->utm_y }}" pattern="[0-9.,]*">
                    @error('utm_y')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                ...
                <div class="col-md-4 mb-2">
                    ...
                    <select name="zone" id="zone" class="form-control @error('zone') is-invalid @enderror">
                        ...
                        <option value="48" {{ old('zone')=='48' || $benchmark->zone == '48' ? 'selected' : '' }}>48
                        </option>
                        <option value="49" {{ old('zone')=='49' || $benchmark->zone == '49' ? 'selected' : '' }}>49
                        </option>
                        <option value="50" {{ old('zone')=='50' || $benchmark->zone == '50' ? 'selected' : '' }}>50
                        </option>
                        <option value="51" {{ old('zone')=='51' || $benchmark->zone == '51' ? 'selected' : '' }}>51
                        </option>
                        <option value="52" {{ old('zone')=='52' || $benchmark->zone == '52' ? 'selected' : '' }}>52
                        </option>
                    </select>
                    @error('zone')
                    <span class="invalid-feedback" role="alert">
                ...
                <div class="col-md-6 mb-2">
                    ...
                    <input type="text" class="form-control" id="lat" name="lat"
                        value="{{ old('lat') ?? $benchmark->lat }}" readonly>
                </div>

                <div class="col-md-6 mb-2">
                    <label for="long" class="form-label">Longitude</label>
                    <input type="text" class="form-control" id="long" name="long"
                        value="{{ old('long') ?? $benchmark->long }}" readonly>
                </div>
                ...
                <div class="col-md-6 mb-2">
                    ...
                    <input type="text" class="form-control" id="tinggi_orthometrik" name="tinggi_orthometrik"
                        value="{{ old('tinggi_orthometrik') ?? $benchmark->tinggi_orthometrik }}"
                        placeholder="Tinggi Orthometrik">
                </div>
                <div class="col-md-6 mb-2">
                    ...
                    <input type="text" class="form-control" id="tinggi_elipsoid" name="tinggi_elipsoid"
                        value="{{ old('tinggi_elipsoid') ?? $benchmark->tinggi_elipsoid }}"
                        placeholder="Tinggi Elipsoid">
                </div>

                <div class="col-md-12 mb-2">
                    <label for="Keterangan" class="form-label">Keterangan</label>
                    <textarea class="form-control" id="keterangan" name="keterangan" rows="3"
                        placeholder="Keterangan">{{ old('keterangan') ?? $benchmark->keterangan }}</textarea>
                </div>

                <div class="col-md-6 mb-2">
                    <label for="sketsa" class="form-label">Sketsa</label>
                    <input class="form-control" type="file" id="sketsa" name="sketsa" accept="image/*">
                    <small class="form-text text-muted"><em>kosongkan jika tidak ubah file</em></small>
                    @if ($sketsaUrl)
                    <img id="sketsa-preview" src="{{ $sketsaUrl }}" alt="Sketsa" class="img-thumbnail mt-2"
                        style="max-width: 100px;">
                    @else
                    <img id="sketsa-preview" src="{{ asset('img/no-image.png') }}" alt="No Image"
                ...
                <div class="col-md-6 mb-2">
                    ...
                    <small class="form-text text-muted"><em>kosongkan jika tidak ubah file</em></small>
                    @if ($fotoUrl)
                    <img id="foto-preview" src="{{ $fotoUrl }}" alt="Foto" class="img-thumbnail mt-2"
                        style="max-width: 100px;">
                    @endif
                </div>
